 ...
 */
public class PrizeDetailHeadView extends RelativeLayout implements NetUtils.RequestCallCack{
    ...
    //private RemainCallBack callBack;
    public PrizeDetailHeadView(Context context) {
        super(context);
        init();
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.custom_prize_detail_head, this, true);
    ...
    public void onSuccess(ResponseInfo<String> responseInfo) {
        ...
        //callBack.callback(data.getRemain_sec());
